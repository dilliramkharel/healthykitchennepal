...
function GuideDetail() {
  ...
  if (!guide || !article) {
    return <div className="flex min-h-screen flex-col bg-background"><Navbar /><main className="flex flex-1 flex-col items-center justify-center px-5 py-32 text-center"><h1 className="text-3xl font-bold">Guide Not Found</h1><p className="mt-3 text-muted-foreground">This guide is not available.</p><Button className="mt-7" asChild><a href="/#guides">Back to guides</a></Button></main><Footer /></div>;
  }
